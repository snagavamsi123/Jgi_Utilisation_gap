...
class output_values_seperation():
    ...
    def result_after_search(self,result,selected_floor_no,selected_date):
        ...
        if (selected_floor_no=='A3'):
            self.total_sew_handle_value = result.A3_Sew_Handle
            self.total_shears_value = result.A3_shears
            self.total_Bundle_value = result.A3_Bundle
            self.total_machine_delay_value = result.A3_Machine_Delay
            self.total_machine_breakdown_value = result.A3_H1_MB
            self.total_pf_value = result.A3_PF
            self.total_wt_value = result.A3_H1_WT
            self.total_others_value = result.A3_Others

        elif (selected_floor_no=='A4'):
